...
class LaMOBlock(nn.Module):
    ...
    def __init__(
        ...
        self.Attn = LaMOAttention(hidden_dim, heads=num_heads, dim_head=hidden_dim // num_heads,
...
class LaMOBlock_Structured_Mesh_2D(nn.Module):
    ...
    def __init__(
        ...
        self.last_layer = last_layer
        self.ln_1 = nn.LayerNorm(hidden_dim)
        self.Attn = LaMOAttention_Structured_Mesh_2D(hidden_dim, heads=num_heads, dim_head=hidden_dim // num_heads,
